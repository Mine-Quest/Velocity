...
public interface MinecraftSessionHandler {
  ...
  default boolean handle(Team packet) {return false;}
  default boolean handle(ScoreboardDisplay packet) {return false;}
  default boolean handle(ScoreboardObjective packet) {return false;}
  default boolean handle(ScoreboardScore packet) {return false;}
}
